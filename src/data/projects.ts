export const projects = [
  ...
  },
  {
    ...
    impact:
      "Automatiza la operación diaria y el control financiero de la academia, desde el registro del estudiante hasta el recibo de pago.",
    tech: ["React", "TypeScript", "Tailwind CSS", "shadcn/ui", "AWS Amplify", "AWS Lambda"],
    image: "",
    github: "https://github.com/Memento-Coding/gym-saas",
    demo: "",
  },
  {
    id: "mealprep",
    ...
    impact:
      "Reduce el desperdicio de alimentos y el tiempo de decisión convirtiendo tu nevera en recomendaciones.",
